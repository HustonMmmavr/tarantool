...
--
-- gh-6106: Make sure that number of arguments check is checked properly for SQL
-- built-in functions with variable number of arguments.
--
...
test:do_catchsql_test(
    ...
    {
        1, "Wrong number of arguments is passed to GREATEST(): expected at least 2, got 0"
    }
)
